...
export default function HomeBio() {
  return (
    <div className="flex items-center justify-center m-5">
      <p>Welcome to Formula One, A History!</p>
      <p>
        ...
        FIA Formula One World Championship has been one of the world's premier
        forms of racing since its inaugural running in 1950. The word formula in
        the name refers to the set of rules all participants' cars must follow.
        A Formula One season consists of a series of races, known as Grands
        Prix. Grands Prix take place in multiple countries and continents on
